...
export default function Dashboard() {
    ...
    const redeemCoins = async () => {
        try {
            const redeem = await axios.post('https://api.paresport.com/redeemCoins', { token: token }, {
                withCredentials: true,
            });

            // Refetch user data to get the updated lastCoinsReceived value
            const updatedUser = await axios.post('https://api.paresport.com/api/auth/getCredentials', { token: token }, {
                withCredentials: true,
            });
